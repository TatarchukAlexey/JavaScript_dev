...
// ///================================  Регулярные выражения    ============================/////////////
   /// Это поиск нужных символов в строке
/*********************************************************************************************************************** */
...
// знак доллара $ используют чтобы указать, 
// что строка должна заканчиваться на указанный паттерн.
...
// Важнооооооооооооооооооо!!!!!!!!!!!!!

// Нужно или скачать с сайта файл или через GIT
{/* <script src="handlebars-v2.0.0.js"></script>
// Обязательно подключить в HTML
<script src="https://cdnjs.cloudflare.com/ajax/libs/handlebars.js/2.0.0/handlebars.js"></script>
// При использовании вебпака нужно просто подгружать модули, скрипт ставить не надо
 */}
