...
//  времени. Принимает два аргумента, 
// 1) callback-функцию и 2) время задержки в миллисекундах,
//  по завершению которого один раз будет вызвана callback-функция. 
// Возвращает цифровой  идентификатор созданного таймера,
//  это необходимо для возможности его удаления.
